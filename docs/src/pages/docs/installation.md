...
Anchor binaries are available via an NPM package [`@solarti/anchor-cli`](https://www.npmjs.com/package/@solarti/anchor-cli). Only `x86_64` Linux is supported currently, you must build from source for other OS'.
